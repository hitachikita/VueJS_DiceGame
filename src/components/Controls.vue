<template>
  <div>
    <button v-on:click="handleNewGame" class="control btn-new">
      <i class="ion-ios-plus-outline"></i>New game
    </button>
    <button v-on:click="handleRollDice" class="control btn-roll">
      <i class="ion-ios-loop"></i>Roll dice
    </button>
    <button v-on:click="handleHoldScore" class="control btn-hold">
...
export default {
  ...
  methods: {
    ...
    handleChangeFinalScore() {
      this.$emit("handleChangeFinalScore", event);
    },
  },
};
</script>
